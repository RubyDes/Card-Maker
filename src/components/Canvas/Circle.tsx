...
const Circle = (props: PropsType & DispatchProps) => {
  ...
  return (
    ...
    >
      <g>
        <path
          style={{ fill: "none", stroke: "#030104", strokeWidth: 0.26 }}
          d="M8,0C3.582,0,0,3.582,0,8s3.582,8,8,8s8-3.582,8-8S12.418,0,8,
          0z"
        />
      </g>
    </svg>
...
const mapDispatchToProps = (dispatch: Function) => {
  return {
    moveSvg: (index: number, x: number, y: number) =>
      dispatch(moveSvg(index, x, y)),
