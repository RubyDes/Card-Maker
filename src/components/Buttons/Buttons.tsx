...
const Buttons = () => {
    ...
    const buttons = [
        { id: '1', title: 'Clear Canvas', nameImg: 'add-file', onClick: clearDescClear },
        { id: '2', title: 'Add Picture', nameImg: 'add-picture', onClick: openDescImg },        //4
        { id: '3', title: 'Add Art-object', nameImg: 'art-object', onClick: openDescArtObj },   //5
